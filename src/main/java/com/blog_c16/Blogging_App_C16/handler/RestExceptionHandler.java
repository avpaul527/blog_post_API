package com.blog_c16.Blogging_App_C16.handler;


import com.blog_c16.Blogging_App_C16.exception.ResourceNotFoundException;
import com.blog_c16.Blogging_App_C16.error.ErrorDetail;
import com.blog_c16.Blogging_App_C16.error.ValidationError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleResourceNotFoundException(ResourceNotFoundException rnfe, HttpServletRequest request){
        ...
        ValidationError validationError = new ValidationError();
        validationError.setCode("Post Not Found");
